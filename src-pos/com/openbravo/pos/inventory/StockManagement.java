...
public class StockManagement extends JPanel implements JPanelView {
    ...
    private void stateTransition(char cTrans) {
        if(cTrans == '\n')
        {
            ...
            try {
                oProduct = m_dlSales.getProductInfoByCode(m_jcodebar.getText());
                if (oProduct != null) {    
                    String units = JOptionPane.showInputDialog("Cantidad:");
                       try{
                           double d = Double.parseDouble(units);
                           incProductByCode(m_jcodebar.getText(),d);
                       } catch(Exception e){
                       }   
                   }
    ...
    private void saveData(InventoryRecord rec) throws BasicException {
        ...
        for (int i = 0; i < m_invlines.getCount(); i++) {
            ...
            sent.exec(new Object[] {
                ...
                inv.getPrice(),m_jreason1.getSelectedItem().toString()
            });
        }
    ...
    private class CatalogListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            String units = JOptionPane.showInputDialog("Cantidad:");
                       try{
                           double d = Double.parseDouble(units);
                           incProduct( (ProductInfoExt) e.getSource(), d);
                m_jcodebar.setText(null);
                       } catch(Exception ex){
                       }
        }  
    ...
    private void initComponents() {
        ...
        m_jcodebar.setPreferredSize(new java.awt.Dimension(235, 30));
        ...
        m_jbtndate.setBounds(370, 0, 40, 32);
        ...
        jPanel3.add(jLabel8);
        jLabel8.setBounds(10, 70, 66, 16);
        jPanel3.add(m_jLocation);
        m_jLocation.setBounds(160, 70, 200, 26);
        jPanel3.add(m_jLocationDes);
        m_jLocationDes.setBounds(370, 70, 200, 26);
        ...
        m_jDelete.setBounds(510, 110, 52, 38);

        jPanel5.setLayout(new java.awt.BorderLayout());
        jPanel3.add(jPanel5);
        jPanel5.setBounds(10, 110, 500, 320);
        ...
        m_jDelete1.setBounds(510, 210, 52, 38);
        ...
        m_jDelete2.setBounds(510, 160, 52, 38);
        ...
        jPanel3.add(m_jreason1);
        m_jreason1.setBounds(370, 40, 200, 20);
