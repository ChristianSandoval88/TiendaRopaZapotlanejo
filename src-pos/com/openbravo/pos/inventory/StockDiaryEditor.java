...
public class StockDiaryEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public StockDiaryEditor(AppView app, DirtyManager dirty) {
        ...
        m_jreason1.addActionListener(dirty);
        writeValueEOF();
    }
    ...
    public void writeValueDelete(Object value) {
        ...
        m_jreason1.setSelectedItem((String) diary[13]);
    ...
    public Object createValue() throws BasicException {
        return new Object[] {
            ...
            (String) m_jreason1.getSelectedItem(),
            productcode,
            productname,
            attsetid,
            attsetinstdesc, (String) m_jreason1.getSelectedItem()
        };
    }
...
//    }
    ...
    private void initComponents() {
        ...
        m_jreason1 = new javax.swing.JComboBox();
        ...
        jPanel1.add(m_jdate);
        m_jdate.setBounds(160, 10, 200, 24);
        ...
        m_jreference.setBounds(280, 70, 130, 24);
        ...
        m_jEnter1.setBounds(420, 70, 40, 32);

        jLabel6.setText(AppLocal.getIntString("label.prodref")); // NOI18N
        jPanel1.add(jLabel6);
        jLabel6.setBounds(160, 70, 120, 16);

        jproduct.setEditable(false);
        jPanel1.add(jproduct);
        jproduct.setBounds(160, 100, 250, 24);
        jPanel1.add(m_jLocation);
        m_jLocation.setBounds(160, 190, 200, 20);
        ...
        jEditProduct.setBounds(420, 100, 40, 32);

        m_jreason1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "OTRO", "PLOMERIA UNIVERSAL", "PLOMERIA INDUSTRIAL", "FERRETERIA URIBE", "EMMSA ", "DURMAN", "AR DE MEXICO", "DELTA TRANSFORMACIONES", "ETISA DE GUADALAJARA", "VALVULAS Y CONEXIONES", "EITSA", "ELECTRICA MP", "ECOZZA", "POLIACERO BUGAMBILIAS", "ACEROS OCOTLAN", "ACEROS MURILLO", "SIFISA", "TACSA", "SIFIJA", "REACSA", "AIRESA", "PINTURAS PRISA", "PINTURAS ACUARIO", "COMEX", "GLASS FIBER", "VERMON", "NAMM", "SIMEXCO", "HIDROVAL", "PARA CONSTRUIR", "MATERIALES ALATORRE", "CALENTADORES NACIONALES", "EVANS", "TATSA", "LUCORD", "RENTABLE EQUIP", "T MAQ", "BLOKERA CARRILLO", "ESTRU BLOCK", "NAPRESA", "NARESA ", "CP AISLAMIENTOS ", "ABASTECEDORA DE LAMINAS", "MAYOREO DE CONFORT", "MORAGAS", "MOVIBAN", "SANIRENT", "PLATAFORMEX", "CONSTRULOCKER", "MOFLES BERNAL", "SPIRODUCTO DE JALISCO", "LOS PINOS", "PRAXAIR", "CEMEX", "RIVEL BOMBAS", "TERMONACIONAL", "FERRETERIA CALZADA", "REZNOR" }));
        jPanel1.add(m_jreason1);
        m_jreason1.setBounds(160, 160, 200, 20);

        jLabel11.setText(AppLocal.getIntString("label.units")); // NOI18N
        jPanel1.add(jLabel11);
        jLabel11.setBounds(10, 130, 150, 16);

        jLabel12.setText("Proveedor");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(10, 160, 150, 16);
    ...
    private javax.swing.JComboBox m_jreason1;
